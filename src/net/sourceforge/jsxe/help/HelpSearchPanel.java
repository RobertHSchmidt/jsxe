...
import net.sourceforge.jsxe.Log;
//}}}

/**
 * The Search panel in the Help Viewer.
 *
 * @author Slava Pestov
...
class HelpSearchPanel extends JPanel {
    ...
    public HelpSearchPanel(HelpViewer helpViewer) {
        ...
        box.add(new JLabel(Messages.getMessage("helpviewer.search.caption")));
    ...
    class ActionHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            results.setListData(new String[] { Messages.getMessage("helpviewer.searching") });
            ...
            VFSManager.runInAWTThread(new Runnable() {
                public void run() {
                    if (resultModel.size() == 0) {
                        results.setListData(new String[] { Messages.getMessage("helpviewer.no-results") });
