...
/**
 * This action that redoes the last action made in the source view.
 *
 * @author Ian Lewis (<a href="mailto:IanLewis@member.fsf.org">IanLewis@member.fsf.org</a>)
 * @version $Id$
 */
public class RedoAction extends LocalizedAction {
    
    //{{{ RedoAction constructor
    public RedoAction() {
        super(SourceViewPlugin.PLUGIN_NAME+ActionManager.REDO_SUFFIX);
    }//}}}
    ...
    public void invoke(TabbedView view, ActionEvent evt) {
        ...
        if (docView instanceof SourceView) {
            ...
            ((SourceViewDocument)sourceView.getTextArea().getDocument()).redo();
        }
    }//}}}
