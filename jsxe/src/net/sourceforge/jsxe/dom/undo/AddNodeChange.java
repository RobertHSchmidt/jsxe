...
/**
 * An undoable edit sigifying an addition of a child to an AdapterNode.
 * @author Ian Lewis (<a href="mailto:IanLewis@member.fsf.org">IanLewis@member.fsf.org</a>)
 * @version $Id$
 * @see net.sourceforge.jsxe.dom.XMLDocument
 * @see net.sourceforge.jsxe.dom.AdapterNode
 */
public class AddNodeChange extends AbstractUndoableEdit {
    
    private AdapterNode m_node;
    private AdapterNode m_child;
    private int m_index;
    
    //{{{ AddNodeChange constructor
    public AddNodeChange(AdapterNode node, AdapterNode child, int index) {
        m_node = node;
        m_child = child;
        m_index = index;
    }//}}}
