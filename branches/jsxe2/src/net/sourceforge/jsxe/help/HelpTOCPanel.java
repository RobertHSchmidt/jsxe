...
class HelpTOCPanel extends JPanel {
    ...
    void load() {
        DefaultTreeModel empty = new DefaultTreeModel(
            new DefaultMutableTreeNode(Messages.getMessage("helpviewer.toc.loading")));
        toc.setModel(empty);
    ...
    private void createTOC() {
        ...
        tocRoot.add(createNode("welcome.html",
            Messages.getMessage("helpviewer.toc.welcome")));

        tocRoot.add(createNode("README.txt",
            Messages.getMessage("helpviewer.toc.readme")));
        tocRoot.add(createNode("CHANGES.txt",
            Messages.getMessage("helpviewer.toc.changes")));
        tocRoot.add(createNode("TODO.txt",
            Messages.getMessage("helpviewer.toc.todo")));
        tocRoot.add(createNode("COPYING.txt",
            Messages.getMessage("helpviewer.toc.copying")));
        tocRoot.add(createNode("COPYING.DOC.txt",
            Messages.getMessage("helpviewer.toc.copying-doc")));
        tocRoot.add(createNode("Apache.LICENSE.txt",
            Messages.getMessage("helpviewer.toc.copying-apache")));
        tocRoot.add(createNode("COPYING.PLUGINS.txt",
            Messages.getMessage("helpviewer.toc.copying-plugins")));
        ...
        DefaultMutableTreeNode pluginTree = new DefaultMutableTreeNode(
            Messages.getMessage("helpviewer.toc.plugins"),true);
